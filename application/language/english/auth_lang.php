...
// Create User
$lang['create_user_heading']                           = '<i class="icon-user"></i>Create User';
...
// Edit User
$lang['edit_user_heading']                           = '<i class="icon-user"></i>Edit User';
...
// Create Group
$lang['create_group_title']                  = '<i class="icon-group"></i>Create Group';
...
// Edit Group
$lang['edit_group_title']                  = '<i class="icon-group"></i>Edit Group';
...
// Change Password
$lang['change_password_heading']                               = '<i class="icon-lock"></i>Change Password';
...
// Forgot Password
$lang['forgot_password_heading']                 = '<i class="icon-lock"></i>Forgot Password';
...
// Reset Password
$lang['reset_password_heading']                               = '<i class="icon-lock"></i>Change Password';
...
// Device Connect Edit
$lang['device_connect_edit_heading']                           = '<i class="icon-bolt"></i> Device Connect Edit';
$lang['device_connect_edit_subheading']                        = 'Please input device information below.';